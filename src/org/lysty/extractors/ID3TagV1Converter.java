...
public class ID3TagV1Converter {

	public static String getV2Tag(String v1Tag) {
		int num = getNumber(v1Tag);
		switch (num) {
		case 0:
			return "Blues";
		case 1:
	...
	private static int getNumber(String v1Tag) {
		return Integer.parseInt(v1Tag);
	}
}
